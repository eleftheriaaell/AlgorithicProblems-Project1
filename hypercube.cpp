...
vector<data> HyperCube::kNNsearch(vector<int> q, int d, int N, int M, int probes){//FIND N NEAREST NEGHBORS
...
vector<data*> HyperCube::range_search(vector<int> q, int d, int minR, int maxR, int M, int probes){//RANGE SEARCH
